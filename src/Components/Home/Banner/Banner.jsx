    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row gap-4 items-center min-h-screen py-6 md:py-16 '>
            ...
            <div className='flex-1 relative'>
                ...
                <div className=' hidden absolute bottom-28   md:flex flex-col items-center border-2 animate-bounce-slow px-12 md:px-24 py-2  rounded-full bg-background border-gold'>
                ...
                <div className=' hidden absolute  bottom-4 right-2 md:flex flex-col items-center border-2 animate-bounce-reverse px-12 md:px-24 py-2  rounded-full bg-background border-gold'>
                    ...
                    <p className=''>Completed <br /> Projects</p>
                </div>
